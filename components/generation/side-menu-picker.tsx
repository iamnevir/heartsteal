...
export default function SideMenuPicker() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "h-[100dvh] flex flex-col gap-3 w-[80%] font-semibold text-xl px-3 duration-500 bg-black border-none fixed right-0 z-[50] top-0",
          pathname === "/ai/settings" && "right-10",
